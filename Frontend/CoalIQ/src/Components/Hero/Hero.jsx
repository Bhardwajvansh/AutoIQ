        ...
        <div className="min-h-screen bg-gray-50 flex flex-col">
            ...
            <div className="bg-gradient-to-tr from-indigo-100 to-purple-100 p-10 mx-auto relative overflow-hidden shadow-sm lg:h-screen">
                ...
                <div className="relative z-10">
                    <h1 className="text-3xl font-bold text-indigo-700 lg:text-7xl mb-4">Welcome to AutoIQ</h1>
                    <br />
                    <p className="text-gray-600">
                        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptatum obcaecati quaerat eligendi corrupti, nesciunt quas sunt enim vero neque nulla repellat eveniet, maxime, recusandae dolore. Eum ratione laborum impedit illum eius voluptatum minus dolorum ipsam, fugit est in dicta soluta.
                    </p>
                    <br />
